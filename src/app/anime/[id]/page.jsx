...
const Page = async ({ params: { id } }) => {
  ...
  // console.log(translateSynopsisToIndonesian) 
  ...
  const translatedSynopsis = await translateSynopsisToIndonesian(anime.data.synopsis)
    ...
    return (
      ...
      <div className="fixed md:visible invisible z-10">
       <Image
      ...
      <div className="IDanime bg-colos-accent dark:bg-colos-sidebarColor xl:px-72 2xl:px-[26rem] md:px-[5rem] xl:py-12 2xl:py-12 py-1">
        <div className="relative details bg-colos-white dark:bg-colos-sidebarColor p-8 z-40 shadow-2xl shadow-colos-primary dark:shadow-colos-Info"> 
       ...
       <h3 className="md:text-4xl xl:text-xl 2xl:text-3xl text-2xl font-bold h1 z-40">
        ...
        <div className="">
              ...
              <h3 className="text-color-primary text-2xl mt-12">Komentar Penonton</h3>
              <CommentBox user_image={user?.image}  anime_mal_id={id}/>
        </div>
       </div>
