...
const Episodes = async({api}) => {
    ...
    return (
        <div className="left-0">
            <h1 className="text-4xl font-bold">Episode</h1>
            ...
            {api.data?.map((episode, index)=> {
                ...
                <div className="md:w-28 w-16 h-14 md:h-24 rounded-xl border border-colos-primary shadow-xl bg-colos-accent hover:bg-colos-SidebarAccent transition-all ease-linear hover:text-colos-accent flex flex-col">
